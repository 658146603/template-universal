...
class UserVerifyController {
    ...
    fun getEmailVerifyCode(@PathVariable page: String?, verifyCodeReq: VerifyCodeReq?): Responses<VerifyCodeResp> {
    ...
    fun verifyEmail(@PathVariable codeId: String?, trustableKeyReq: TrustableKeyReq?): Responses<TrustableKeyResp> {
